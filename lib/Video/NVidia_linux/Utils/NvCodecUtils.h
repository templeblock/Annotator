...
void Nv12ToRgba32(uint8_t* dpNv12, int nNv12Pitch, uint8_t* dpRgba, int nRgbaPitch, int nWidth, int nHeight, int iMatrix = 0);
...
void P016ToRgba32(uint8_t* dpP016, int nP016Pitch, uint8_t* dpRgba, int nRgbaPitch, int nWidth, int nHeight, int iMatrix = 4);
