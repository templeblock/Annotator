...
void Nv12ToRgba32(uint8_t *dpNv12, int nNv12Pitch, uint8_t *dpRgba, int nRgbaPitch, int nWidth, int nHeight, int iMatrix) {
    SetMatYuv2Rgb(iMatrix);
    YuvToRgbKernel<uchar2, RGBA32, uint2>
        <<<dim3((nWidth + 63) / 32 / 2, (nHeight + 3) / 2 / 2), dim3(32, 2)>>>
        (dpNv12, nNv12Pitch, dpRgba, nRgbaPitch, nWidth, nHeight);
}
...
void P016ToRgba32(uint8_t* dpP016, int nP016Pitch, uint8_t* dpRgba, int nRgbaPitch, int nWidth, int nHeight, int iMatrix) {
    SetMatYuv2Rgb(iMatrix);
    YuvToRgbKernel<ushort2, RGBA32, uint2>
        <<<dim3((nWidth + 63) / 32 / 2, (nHeight + 3) / 2 / 2), dim3(32, 2)>>>
        (dpP016, nP016Pitch, dpRgba, nRgbaPitch, nWidth, nHeight);
}
