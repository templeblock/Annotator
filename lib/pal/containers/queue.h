...
private:
	...
	size_t Mask() const { return RingSize - 1; }
	void*  Slot(size_t pos) const { return (uint8_t*) Buffer + (pos * ItemSize); }
	void   Increment(size_t& i) const { i = (i + 1) & Mask(); }
	size_t SizeInternal() const { return (Head - Tail) & Mask(); }
	void   Grow();
};
...
public:
	...
	Semaphore&  SemaphoreObj() { return Q.Semaphore; }
