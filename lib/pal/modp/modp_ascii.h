 ...
 */
IMQS_PAL_API void modp_toupper(char* str, size_t len);
 ...
 */
IMQS_PAL_API void modp_toupper_copy(char* dest, const char* str, size_t len);
 ...
 *
 */
IMQS_PAL_API void modp_tolower(char* str, size_t len);
 ...
 * http://www.azillionmonkeys.com/qed/asmexample.html
 */
IMQS_PAL_API void modp_tolower_copy(char* dest, const char* str, size_t len);
 ...
 *
 */
IMQS_PAL_API void modp_toprint(char* str, size_t len);
 ...
 * dest!
 */
IMQS_PAL_API void modp_toprint_copy(char* dest, const char* str, size_t len);
 ...
 */
IMQS_PAL_API size_t modp_rtrim(char* str, size_t len);
