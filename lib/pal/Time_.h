...
public:
	...
	Time(int year, time::Month month, int day, int hour, int minute, int second, int nsec);
	...
	int           Year() const;  // Compute year only (consider using DateComponents if retrieving more than just the year)
